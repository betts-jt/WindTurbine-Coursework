function [Mt, Mn,Power, y, a_out, adash_out, phi, Cn, Ct, Chord] = WTSingleVelocity(V0, Theta0, ThetaTwist, MeanChord, ChordGrad, TipRadius, RootRadius, omega, B, BladeArea, rho)
