function [x] = WTOptimisation(Initial, Lb, Ub)
...
opts.MaxIter = 1000; %Max number of iterations

[x, diff, exitflag] = fminsearchbnd(@DiffCost, [deg2rad(2.5) deg2rad(-1) -0.1], [deg2rad(2) deg2rad(-1) 0], [deg2rad(10) deg2rad(-1) 0.1], opts);
